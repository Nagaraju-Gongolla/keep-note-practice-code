...
public class NoteRepositoryTest {
	...
	public void testUpdateNote() {
		...
		updatedNote.setNoteId(1);
		updatedNote.setNoteTitle("Technology");
		updatedNote.setNoteContent("Spring");
		updatedNote.setNoteStatus("Pending");

		// updating the note
		noteRepository.updateNote(updatedNote);
		// verify data is updated
		assertTrue(noteRepository.exists(updatedNote.getNoteId()));
		Note updatedNote1 = noteRepository.getAllNotes().get(0);
