...
public class NoteController {
	 ...
	 */
	@RequestMapping("/")
	public String findAllNotes(ModelMap modelmap) {
	 ...
	 */
	@RequestMapping("/add")
	public String addNote(ModelMap modelMap, @RequestParam String noteTitle, @RequestParam String noteContent,
			@RequestParam String noteStatus) {

		if (noteTitle.isEmpty() || noteTitle.equals("") || noteContent.isEmpty() || noteContent.equals("")
				|| noteStatus.isEmpty() || noteStatus.equals("")) {
